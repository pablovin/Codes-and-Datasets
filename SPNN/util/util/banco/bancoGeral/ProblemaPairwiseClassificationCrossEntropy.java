...
public class ProblemaPairwiseClassificationCrossEntropy extends TipoProblema{

	private int totalRodadas;
	
	public ProblemaPairwiseClassificationCrossEntropy(int qtClasses) {
		super(qtClasses);
	...
	public String toString() {
		return "Pairwise Classification CrossEntropy";
	}
	...
	public static void main(String[] args) {
		...
		int qtClasses = 5;
		ProblemaPairwiseClassificationCrossEntropy problema = new ProblemaPairwiseClassificationCrossEntropy(qtClasses);
