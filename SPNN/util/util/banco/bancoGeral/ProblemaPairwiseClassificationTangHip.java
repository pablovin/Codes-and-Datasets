...
public class ProblemaPairwiseClassificationTangHip extends TipoProblema{

	private int totalRodadas;
	
	public ProblemaPairwiseClassificationTangHip(int qtClasses) {
		super(qtClasses);
	...
	public String toString() {
		return "Pairwise Classification TangHip";
	}
...
public static void main(String[] args) {
		...
		int qtClasses = 5;
		ProblemaPairwiseClassificationTangHip problema = new ProblemaPairwiseClassificationTangHip(qtClasses);
