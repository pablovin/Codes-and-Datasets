...
public class ProblemaUmContraTodosSigmLog extends TipoProblema{


	public ProblemaUmContraTodosSigmLog(int qtClasses) {
		super(qtClasses);
	}
	...
	public String toString(){
		return "Problema Um contra Todos SigmLog";
	}
